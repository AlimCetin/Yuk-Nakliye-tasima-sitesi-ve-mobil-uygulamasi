...
export default function Address() {
 ...
 <div className="text-center"><button type="submit" className="btn btn-color px-5 mb-5 "  onClick={()=>{addItem()}}>Rota Ekle</button></div>    </>   
    ...
    <ul>
       ...
       {!!items.length && (
        <>
               <div className="text-center"><button type="submit" className="btn btn-color px-5 mb-5 "  onClick={()=>{submitItem()}}>Rota belirlemeyi tamamla</button></div>   
