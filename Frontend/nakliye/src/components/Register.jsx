        ...
        <div className="container">
            <div className="row">
                <div className="col-md-6 offset-md-3">
                    <h2 className="text-center text-dark mt-5">Register Nakliye</h2>
                    <div className="card my-5">
                        <form className="card-body cardbody-color p-lg-5">
                            ...
                            <div className="text-center"><button type="submit" className="btn btn-color px-5 mb-5 w-100" onClick={()=>registerOnClick}>Kayıt</button></div>
                        </form>
                    </div>
                </div>
            </div>
